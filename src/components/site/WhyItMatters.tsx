    ...
    <section className="relative py-32 md:py-48 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 md:px-12">
        <div className="max-w-[640px]">
          ...
          <ul className="mt-14 space-y-8 max-w-[52ch] border-l-2 border-bronze/60 pl-8">
            {[
              ...
              <li key={line}>
                <p className="font-serif text-xl md:text-2xl leading-snug text-foreground font-medium">
                  {line}
                </p>
              </li>
            ))}
