        ...
        <div className="grid grid-cols-12 gap-8 md:gap-16 items-start">
          <div className="col-span-12 md:col-span-5">
            <div className="aspect-[4/5] overflow-hidden">
              <img
                src={founderPortrait}
                alt="Krisztina Szabó-Vedress, Founder of Branded Living CE"
          ...
          <div className="col-span-12 md:col-span-7 md:pl-4">
            <span className="eyebrow">Founder — 007</span>
            <h2 className="mt-6 font-serif text-3xl md:text-5xl lg:text-[3.2rem] leading-[1.1] text-foreground">
            ...
            <p className="mt-10 font-serif italic text-2xl md:text-3xl text-foreground max-w-[32ch] leading-snug">
